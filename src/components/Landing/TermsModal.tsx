...
const termsSections = [
    {
        ...
        content: (
            <>
                ...
                <span className="terms-section-title">section ii: technical scope &amp; 3d digital twin capabilities</span>
                ...
                <p><strong>2.2 3D Digital Twin Engine:</strong> The Platform provides a high-fidelity <strong>Digital Twin Rendering</strong> of the storage asset. This spatial model utilizes real-time telemetry to visualize fuel levels, temperature gradients, and vapor pressure loads. You acknowledge that slight visual discrepancies may exist between the 3D model and physical asset due to tank tilt (out-of-plumb), sediment build-up, or floor deformations found in aged underground storage tanks (USTs). The 3D view is an orientation tool and should be cross-referenced with raw metric data.</p>
                ...
                <p><strong>2.5 System Maintenance Windows:</strong> Strategic updates to the neural forecasting models and digital twin shaders are performed weekly (Sundays, 02:00–04:00 EAT). During these windows, real-time telemetry visualization may be intermittently unavailable, though local data caching on the IoT Gateway will ensure no telemetry continuity loss occurred. Routine maintenance is not counted towards downtime in our uptime SLAs provided notice was displayed in-app.</p>
