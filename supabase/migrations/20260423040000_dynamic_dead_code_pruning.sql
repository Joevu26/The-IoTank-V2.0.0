-- supabase/migrations/20260423040000_dynamic_dead_code_pruning.sql
-- ============================================================================
-- DEAD CODE PRUNING (Dynamic Phase)
-- Dynamically dropping all overloaded signatures of orphaned legacy functions
-- to clear all remaining Supabase Linter warnings.
-- ============================================================================
