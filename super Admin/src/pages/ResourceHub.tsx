...
const ResourceHub: React.FC = () => {
    const [activeSection, setActiveSection] = useState<'announcements' | 'help'>('announcements');
    ...
    const sections = [
        { id: 'announcements', label: 'Broadcast Studio', icon: <FiBell /> },
        { id: 'help', label: 'Knowledge Base', icon: <FiHelpCircle /> }
    ];
        ...
        <Layout>
            <div className="fleet-hub-container">
                ...
                <div className="hub-content-surface animate-fade-in">
                    {activeSection === 'announcements' && <Announcements isHubView={true} />}
                    {activeSection === 'help' && <HelpCenter isHubView={true} />}
                </div>
            </div>
        </Layout>
    );
